...
# 参数列表（在这里修改取值）
BATCH_SIZES=(8)                  # 你想尝试的 batch_size
LEARNING_RATES=("1e-3")  # 学习率，支持科学计数法（字符串形式）
FC1_OUTS=(128)                    # 分类头第一层维度
FC2_OUTS=(128)                    # 分类头第二层维度
DROPOUT1S=(0.5)                   # dropout1
DROPOUT2S=(0.7)                   # dropout2
