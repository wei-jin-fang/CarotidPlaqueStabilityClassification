...
class ResNet3DClassifierWithMask(nn.Module):
    ...
    def __init__(self, num_classes=2, pretrained_path=None, freeze_backbone=True,args=None):
        """
        参数:
            num_classes: 分类类别数
        ...
        # 分类头使用 args 中的参数
        self.fc1 = nn.Linear(512 * BasicBlock.expansion, args.fc1_out)
        self.bn_fc1 = nn.BatchNorm1d(args.fc1_out)
        self.relu_fc1 = nn.ReLU(inplace=True)
        self.dropout1 = nn.Dropout(args.dropout1)
        self.fc2 = nn.Linear(args.fc1_out, args.fc2_out)
        self.bn_fc2 = nn.BatchNorm1d(args.fc2_out)
        self.relu_fc2 = nn.ReLU(inplace=True)
        self.dropout2 = nn.Dropout(args.dropout2)
        self.fc3 = nn.Linear(args.fc2_out, num_classes)
...
def create_mask_guided_classifier(num_classes=2, pretrained_path=None, freeze_backbone=True,args=None):
    """
    创建Mask加权池化分类器的便捷函数
